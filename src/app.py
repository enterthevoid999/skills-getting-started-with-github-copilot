...
activities = {
    ...
    "Soccer Team": {
        "description": "Join the school soccer team for regular practice and interschool matches",
    ...
    "Drama Club": {
        "description": "Practice theater, acting, and stage performances",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Debate Team": {
        "description": "Develop public speaking and competitive debate skills",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["harper@mergington.edu", "jack@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve puzzles, explore math concepts, and prepare for competitions",
